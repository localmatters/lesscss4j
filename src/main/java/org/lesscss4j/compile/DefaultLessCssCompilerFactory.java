...
import org.lesscss4j.transform.FunctionTransformer;
...
public class DefaultLessCssCompilerFactory implements LessCssCompilerFactory {
     ...
     * resource loader (i.e. {@link org.lesscss4j.parser.DefaultStyleSheetResourceLoader
    ...
    /**
     * Create the default mapping between {@link org.lesscss4j.model.AbstractElement AbstractElement} subclass and
     * {@link Transformer}.
     */
